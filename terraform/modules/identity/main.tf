...
# long-lived credentials — see docs/deployment_phases/phase-01-identity.md).
...
# instead of a stored secret — see the note in docs/deployment_phases/phase-01-identity.md.
